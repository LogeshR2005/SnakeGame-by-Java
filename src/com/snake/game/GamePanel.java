...
public class GamePanel extends JPanel   implements ActionListener{
	...
	public void draw(Graphics g) {
		...
		for(int i =0; i < bodyParts; i++) {
		    ...
		    g.drawString("Score : "+this.applesEaten,(SCREEN_WIDTH - metrices.stringWidth("Score : "+this.applesEaten))/2
		    		,g.getFont().getSize());
	...
	public void gameOver(Graphics g) {
	    ...
	    g.drawString("Score : "+this.applesEaten,(SCREEN_WIDTH - metrices1.stringWidth("Score : "+this.applesEaten))/2
	    		,g.getFont().getSize());
		
		g.setColor(Color.red);
		g.setFont(new Font("Ink Free",Font.BOLD,75));
	    FontMetrics metrices2 = getFontMetrics(g.getFont());
	    g.drawString("Game Over",(SCREEN_WIDTH - metrices2.stringWidth("Game Over"))/2
	    		,SCREEN_HEIGHT/2);
